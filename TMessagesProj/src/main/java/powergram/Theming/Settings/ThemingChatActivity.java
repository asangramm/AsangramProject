            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                    ...
                    if (i == headerColorRow) {
                        ...
                        },themePrefs.getInt("chatRLinkColor", 0xff236ea7), CENTER, 0, true);
                        colorDialog.show();
                        ...
                        },themePrefs.getInt("chatLLinkColor", 0xff236ea7), CENTER, 0, true);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == headerColorRow) {
                    ...
                    textCell.setTextAndColor(LocaleController.getString("RBubbleColor", R.string.RBubbleColor), themePrefs.getInt("chatRBubbleColor", 0xffefffde), true);
                } else if (i == lBubbleColorRow) {
                    ...
                    textCell.setTextAndColor(LocaleController.getString("RLinkColor", R.string.RLinkColor), themePrefs.getInt("chatRLinkColor", 0xff236ea7), true);
                } else if (i == lLinkColorRow) {
                    textCell.setTag("chatLLinkColor");
                    textCell.setTextAndColor(LocaleController.getString("LLinkColor", R.string.LLinkColor), themePrefs.getInt("chatLLinkColor", 0xff236ea7), true);
                } else if (i == nameColorRow) {
